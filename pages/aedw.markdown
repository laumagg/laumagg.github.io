...
team:
  ...
  artists:
    - name: Nora Krahl
      url: https://xr-unites.fki.htw-berlin.de/en/current-fellows/
    - name: Amir Baltic
    - name: Christoph Clausen

gallery-media-path: /uploads/aedw

publication:
  title: "Am Ende Der Welt - Shifting MR Boundaries With a Co-Located Multiplayer with Meta Quest 2"
  venue: 12th IEEE IDAACS
  year: 2023
  url: https://ieeexplore.ieee.org/document/10348744
---
